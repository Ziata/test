...
export default function SupportingScientistsPage(props) {
    ...
    let type: string = params.type as string ?? 'principal-investigators-shanghai';
    ...
    const menusList = [
        ...
        // },
        {
            id: 'principal-investigators-shanghai',
            categoryName: 'principal-investigators-shanghai',
            title: t('Principal Investigators shanghai')
        },
        // {
        //     id: 'chen-scholars',
        //     categoryName: 'chen-scholars',
                    ...
                    <Main>
                        <header
                            ...
                            <ListBoxPlain menus={menusList}
                                          selectId={selectedId}
                                          className={'hidden md:flex no-click'}
                                          buttonClassName='!py-0 !min-w-0  no-click'
                                          optionsClassName='lg:w-auto right-0  no-click'
                                          onChange={(id) => {
                                              setSelectedId(id)
                            ...
                            {
                                loading ? '' : <ListBox className="flex  md:hidden -ml-3  no-click"
                                                        optionsClassName={'no-click'}
                                                        menus={menusList}
                                                        selectId={selectedId}
                                                        onChange={(id) => {
                                                            setSelectedId(id)

...
import OurPriorities from '../components/Vision/OurPriorities';
...
export default function VisionPage(props) {
  ...
  const visionPage: any = data?.page?.translation?.visionPage;
        ...
        <Body>
          <Main>
            ...
            <Section className='!mt-12'>
              <OurPriorities visionPage={visionPage}/>
            </Section>
...
`;
VisionPage.variables = (seedQuery, ctx) => {
  return {

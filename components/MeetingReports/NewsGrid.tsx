...
export default function NewsGrid({
    ...
    const queryVariables = {
        ...
        categories: getCategories('meeting-reports', router),
            ...
            {showFilterBar && !loading && <FilterBar
                ...
                onChange={
                    (filterProps) => {
                        ...
                        let linkStr = window.location.pathname + `?year=${data.yearType}&meetingReports=${data.meetingReportType}&page=1`
